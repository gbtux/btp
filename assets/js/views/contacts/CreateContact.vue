<template>
    <v-flex lg12>
        ...
        <v-form>
            <v-text-field v-model="contact.prenom" label="Prénom"></v-text-field>
            <v-text-field v-model="contact.nom" label="Nom"></v-text-field>
...
<script>
    export default {
        ...
        methods: {
            submit() {
                this.$store.dispatch('contact/createContact', {contact: this.contact}).then(() => {
